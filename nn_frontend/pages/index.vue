  ...
  mounted() {
    axios.get('http://127.0.0.1:39112/map/').then(response => {
      for (const item of response.data) {
        ...
        } // else if (item.place_categories === 'alert') {
        //   markersAlert.push({
        //     position: {
        //       lat: item.place_latitude,
        //       lng: item.place_longitude
        ...
        //     draggable: false
        //   })
        // } else if (item.place_categories === 'fire') {
        //   markersFire.push({
        //     position: {
        //       lat: item.place_latitude,
        //       lng: item.place_longitude
        ...
        //     draggable: false
        //   })
        // } else if (item.place_categories === 'radio') {
        //   markersRadio.push({
        //     position: {
        //       lat: item.place_latitude,
        //       lng: item.place_longitude
        ...
        //     draggable: false
        //   })
        // } else if (item.place_categories === 'tree') {
        //   markersTree.push({
        //     position: {
        //       lat: item.place_latitude,
        //       lng: item.place_longitude
